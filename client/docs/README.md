...
| The participant directory (team list) | [`app/(pages)/(user)/participants.tsx`](app/(pages)/(user)/participants.md), then [`useTeamDirectory`](lib/hooks/useTeamDirectory.md) |
