...
A few screens set `headerShown: false` because they render their own header instead of the navigator's: `index` and `login` ([`WelcomeHero`](../lib/components/onboarding/WelcomeHero.md) / [`ParticipantHero`](../lib/components/home/ParticipantHero.md)), `participants` ([`ParticipantListHeader`](../lib/components/participants/ParticipantListHeader.md)), `game`, `rules`, `settings`, `info`, `legal` and `choose-your-character` ([`GameHeader`](../lib/components/game/GameHeader.md)), `schedule` ([`ScheduleHeader`](../lib/components/schedule/ScheduleHeader.md)), plus the full-screen `timer` and `lottery-results`.
