const translations = {
  ...
  participants: {
    title: "Participants",
    search: "Search team or country...",
    teamsLabel_one: "team",
    teamsLabel_other: "teams",
    teamCount_one: "1 team",
    teamCount_other: "{{count}} teams",
    empty: "No teams found",
    emptyHint: "Teams appear here once they have been imported",
    emptyHintSearch: "Try a country shorthand like AT or a team name",
  },
  navigation: {
    back: "Back",
  },
  ...
  results: {
    ...
    tieDetected: "Tie detected on place {places}.",
    gateReady: "All four signatures are in — ready to submit.",
    gateSubmitted: "Result was submitted to the tournament office.",
    gateMissingScores: "the scores",
    gateMissingPlacements: "the placements",
    gateMissingSignatures1: "One signature is missing.",
    gateMissingSignatures2: "Two signatures are missing.",
    gateMissingSignatures3: "Three signatures are missing.",
    gateMissingSignatures4: "Four signatures are missing.",
    gateMissingPrefix: "Still needed: {items}.",
  ...
  signature: {
    ...
    clear: "Clear",
    confirm: "Confirm",
    progress: "Player {current} of {total} · {signed}/{total} signed",
    summary: "{score} points · Place {place}",
    summaryTie: "{score} points · Place {place} (tie)",
  ...
  components: {
    schedule: {
      ...
      durationPlannedMinutes: "{{minutes}} min planned",
      minutesUnit: "min",
